...
public class WorstFit {
    ...
    public synchronized void sortFreeBlocksID() {
        Collections.sort(freeblocks, new Comparator<MemoryCell>() {  //Sort arraylist of freeblocks by M#ID
            @Override
    ...
    public synchronized void sortFreeBlocksSize() {
        Collections.sort(freeblocks, new Comparator<MemoryCell>() { // Sort the arraylist of freeblocks by size, according to worstfit.
            @Override
            public int compare(MemoryCell m1, MemoryCell m2) {
